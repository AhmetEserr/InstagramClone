...
public class MyFotoAdapter extends RecyclerView.Adapter<com.example.instagramclone.Adapter.MyFotoAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new com.example.instagramclone.Adapter.MyFotoAdapter.ViewHolder(view);
    }
